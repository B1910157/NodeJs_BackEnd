...
router.post("/create_payment_url", function (req, res, next) {
  ...
  var returnUrl = "http://localhost:3001/payment-success";

  var date = new Date();

  var createDate = dateFormat(date, "yyyymmddHHmmss");
  // var orderId = dateFormat(date, "HHmmss");
  var dateOrder = dateFormat(date, "HHmmss");
  var orderId = req.body.orderId + "_" + dateOrder;
  console.log("orderId nè: ", orderId);
  var amount = req.body.amount;
  var bankCode = "NCB";

  var orderInfo = "ThanhToanDatTiec";
